...
#        and one is WRONG.  Which is the WRONG one? The second one as it uses loop variable and accumulation
#
#              x = starting_point.x
#              for k in range(n):
